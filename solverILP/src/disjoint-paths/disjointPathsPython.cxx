...
//            .def(py::init<>())
//            .def("parse_file",&disjointPaths::ParametersParser::parseFile,"Parses parameters from file")
//            .def("parse_stream",&disjointPaths::ParametersParser::parseStream<std::stringstream>,"Parses parameters stream");
